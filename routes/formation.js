...
router.get("/myFormations", formationCtrl.getAllFormations);
...
router.patch(
  "/updateFormation/:title",
  auth,
  formationCtrl.updateFormationByTitre
);

router.patch(
  "/updateFormationById/:id",
  auth,
  formationCtrl.updateFormationById
);
...
router.patch(
  "/depublierFormation/:id",
  auth,
  formationCtrl.depublierFormationById
);

router.patch(
  "/unarchiveFormation/:id",
  auth,
  formationCtrl.unarchiveFormationById
);
