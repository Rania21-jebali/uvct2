...
function Candidat() {
  ...
  return (
      <div className='candidat'>
        ...
        <Button className="btn-accepter" onClick={() => handleAccept(admin._id) }>Accepter</Button>
       </div> 
        <div className="content-candidat">
            <h1 className='name-candidat'>{admin.name}</h1>
            <h5 className='info-candidat'><WorkOutlineIcon className='icon-details'/>{admin.specialite}</h5>
            <h5 className='info-candidat'><PhoneIcon className='icon-details'/>{admin.tele}</h5>
            <h5 className='info-candidat'><MailOutlineIcon className='icon-details'/>{admin.email}</h5>
            <h5 className='info-candidat'><DescriptionIcon className='icon-details'/>{admin.cv}</h5>
